...
def parse_arguments():
    ...
    # File paths
    parser.add_argument(
        "--log_path", help="Path to single log file, which is split into train and test"
    )
    ...
    parser.add_argument(
        "--central_orchestration", action="store_true", help="Enable central orchestration"
    )
    parser.add_argument(
        "--determine_automatically",
        action="store_true",
        help="Enable automatic determination of simulation parameters",
    )
